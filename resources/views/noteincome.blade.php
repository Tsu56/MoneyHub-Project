            ...
            <div class="modal-content">
                ...
                <form action="" method="psot">
                    <div class="modal-body">
                        ...
                        <input class="form-control" type="text" name="input-cate-name" id="input-cate-name">
                    </div>
        ...
        <form action="{{ route('moneyhub.inserttransaction') }}" method="post">
            ...
            <div class="row">
                ...
                <div class="col-2 d-none" id="show-edit-del">
                    <button type="button" data-bs-toggle="modal" data-bs-target="#edit-cate" class="btn btn-warning mx-1" onclick="insertMoEdit()">แก้ไข</button>
                    <button type="button" data-bs-toggle="modal" data-bs-target="#del-cate" class="btn btn-danger mx-1" onclick="insertMoDel()">ลบ</button>
                </div>
            </div>
            <input type="text" class="form-control" placeholder="กรอกประเภทอื่นๆ" name="otherCategory" id="otherCategory"
                hidden>


            <div class="mb-3 mt-3">
                <label for="money" class="form-label">จำนวนเงิน(บาท) :</label>
                <input type="number" step="0.01" class="form-control" id="money" placeholder="00.00" name="amount"
                    required>
            </div>
